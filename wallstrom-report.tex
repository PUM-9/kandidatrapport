...
Denna rapport kommer endast att undersöka vad den specifika metoden kodgranskning har för påverkan på kvaliteten hos ett mjukvarusystem. Det finns flera metoder som påverkar kvaliteten på ett system men dessa kommer inte undersökas eftersom just kodgranskning har använts under det relaterade kandidatprojektet. En annan avgränsning är den litteraturstudie och enkät som gjorts. Litteraturstudien skulle varit mer omfattande och undersökt fler än två vetenskapliga artiklar, det gjorde inte på grund av att det var för tidskrävande. Den genomförda enkäten hade för låg svarsfrekvens, det skulle krävas en större mängd deltagande personer för att få trovärdig och representativ data. 

...
\begin{figure}[H]
	...
	\label{fig:jrmpc_result}
\end{figure}

Nedan i fig \ref{fig:registrered_church_serie} ses från övre vänster till nedre högra bilden delresultatet av 12, 13, 18, 19 samt 20 punktmoln extraherat från en och samma körning. Notera till exempel resultatet för 20 punktmoln där man tydligt i främre vänstra hörnet på kyrkan ser dubbla hörn. Det här kommer av att punktmoln
\begin{figure}[H]
	\centering

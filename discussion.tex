...
Som tydligt kan ses i denna rapport har inte projektet gått som det var planerat. Vi har under projektets gång (speciellt under projektets andra halva) varit kritiska över hur vi gått tillväga. I avsnitt \ref{cha:results_experiences} har vi listat de erfarenheter som vi kunnat dokumentera under projektets gång. Bland dessa finns erfarenheter om vad vi borde ha gjort annorlunda. Vi borde ha testat det befintliga systemet, TreeD, mer rigoröst tidigt istället för att lita på att det fungerade felfritt.

...
\subsection{Hur kan ett system för 3D-kopiering implementeras så att man skapar värde för kunden? (WIP rubrik)}

\subsection{Vilka erfarenheter kan dokumenteras från ett 3D-kopieringsprojekt som kan vara intressanta för framtida projekt?(WIP rubrik)}

\subsection{Systemanatomi}

\subsection{Hur påverkas projektet av en helt reviderad kravspecifikation efter hälften av projektets gång?(WIP rubrik)}

\subsection{Hur har gruppens tillvägagångssätt ändrats på grund av faktumet att vi vidareutvecklade ett system?(WIP rubrik)}

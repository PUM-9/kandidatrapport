...
% RESULTAT
Gruppen hade satt ett väldigt högt mål för iteration ett och blev därför inte klar med allt som var tänkt. Gruppmedlemmarna var nöjda med resultatet ändå, just på grund av det högt satta målet.
% SLUT RESULTAT

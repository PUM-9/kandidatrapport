...
Mercurial \cite{mercurial}, likt SVN och Git är också ett versionshanteringsprogram. Mercurial är ett distribuerat versionshantersprogram som Git.
...
\subsection{Metod}
Litteraturstudien för frågeställning 1 kunde kanske ha gett ett annat eller mer utförligare svar om fler artiklar, bloggar och liknande hittats. Nu när det är rätt så få källor som jag hittat kan det ge en missrepresentativ bild av resultatet.
...
De källor som har använts i rapporten 

...
För att kunna besvara frågeställningarna, har dem delats upp i tre olika sektioner för att beskriva hur det gick till att besvara dem.
%För att kunna besvara frågeställningarna har dem delats upp i tre sektioner för hur jag gick tillväga för att svara på dem.
...
Resultatet som kommits fram till från min litteraturstudie och de två enkäter som beskrevs i metoden visas nedan.

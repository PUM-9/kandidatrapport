...
\subsection{Enkät 1}
Det jag kommit fram till med hjälp av min enkätundersökning är att Git, Google Docs och ShareLaTeX är bra verktyg att använda sig av när man skriver större dokument. 
